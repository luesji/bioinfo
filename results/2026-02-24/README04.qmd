...
curl_download(
  ...
  destfile = 'z1.txt')
```
##la diferencia es (URLencode());;; este segundo bloque está más compacto que el tercero
```{r}
...
```
##este es como el mismo que el segundo bloque, es más visual pero requiere el definir términos etc;; además se puede reutilizar redefiniendo los términos; se divide el proceso en varias fases que se pueden aprovechar después
:::

...
- [fastp](https://github.com/OpenGene/fastp) [@Chen2018]. Si descargas el
  ...
  ## Para instalar es copiar enlace, y luego poner en terminal las siguientes órdenes:
...
RESPUESTA: wc -l DRR025089_1.fastq.gz
271732 DRR025089_1.fastq.gz
wc -l DRR025089_2.fastq.gz
270729 DRR025089_2.fastq.gz
:::
...
```
## ls -1  para comprobar lo que tiene la carpeta
